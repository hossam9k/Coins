...
import org.poc.app.core.domain.model.DefaultLogger
import org.poc.app.core.domain.model.NoOpAnalyticsLogger
import org.poc.app.core.domain.model.TestDispatcherProvider
...
class PortfolioViewModelTest {
    ...
    fun `ViewModel initializes successfully`() =
        runTest {
            ...
            assertTrue(
                viewModel.state.value.portfolioValue
                    .isEmpty() ||
                    viewModel.state.value.portfolioValue
                        .isNotEmpty(),
            )
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun `Repository works correctly`() =
        runTest {
